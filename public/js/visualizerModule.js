let visColor = function(canvas, jsonAudioInit, jsonAudioGraph, results, color, x, h, w, f) {
...
let visualizer = function (canvas, jsonAudioInit, jsonAudioGraph, results, color, h, w,f ) {
    let x = 0
