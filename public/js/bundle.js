...
var startMello = function startMello() {
  var canvas = (0, _setUpModule.getCanvas)();
  var jsonAudioInit = (0, _setUpModule.audioInit)(canvas);
  var jsonAudioGraph = (0, _setUpModule.audioGraph)(canvas, jsonAudioInit);
  ...
  var draw = function draw() {
    ...
    (0, _visualizerModule.visualizer)(canvas, jsonAudioInit, jsonAudioGraph, results, currColor, changeParam.barHeight, changeParam.barWidth, changeParam.barFit, changeParam.canvasClr);
  };
...
},{"./setUpModule.js":2,"./visualizerModule":4,"dat.gui":1}],4:[function(require,module,exports){
"use strict";
...
var visColor = function visColor(canvas, jsonAudioInit, jsonAudioGraph, results, color, x, h, w, f) {
  for (var i = 0; i < jsonAudioGraph.analyser.frequencyBinCount; i++) {
    var barHeight = results[i] * h;
...
var visualizer = function visualizer(canvas, jsonAudioInit, jsonAudioGraph, results, color, h, w, f, canvClr) {
  var x = 0;
