...
var startMello = function startMello() {
  ...
  var draw = function draw() {
    ...
    (0, _visualizerModule.visualizer)(canvas, jsonAudioInit, jsonAudioGraph, results, currColor, changeParam.barHeight, changeParam.barWidth, changeParam.barFit);
  };
...
var visualizer = function visualizer(canvas, jsonAudioInit, jsonAudioGraph, results, color, h, w, f) {
  var x = 0;
