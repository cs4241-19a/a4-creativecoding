...
Physijs.scripts.ammo = "../js/ammo.js";
    initScene = function() {
      ...
      function start() {
          ...
          document.getElementById("textstart").innerHTML = "Click, hold and drag th" +
              "e center of the wooden plank. Press w' and 's' to shift the plank's dimentions." +
              " Press 'a' to alter the cube's color. Press 'd' to disable bounce. Press 'x' to" +
              " disable music. These won't help you but the assignment requires that I have " +
              "them. Keypresses will not register while you're holding the plank. Balance the" +
              " cube. Click to start. Click to restart when you lose. My high score is 31."
      }
      function dismiss() {
