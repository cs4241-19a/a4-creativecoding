import { openInfo, clickColor, customColor, saveImage, triggerClick, changeBrushStyle, fillCanvas, changeBrushSize, clearCanvas, changeColor } from './main.js';

/* assigns the onclick functions to the tool buttons */

document.querySelector('#openFile').addEventListener('click', triggerClick);
...
document.querySelector('#buttBrush').addEventListener('click', function () { changeBrushStyle('butt'); });
...
document.querySelector('#brushSize1').addEventListener('click', function () { changeBrushSize(5); });

document.querySelector('#brushSize2').addEventListener('click', function () { changeBrushSize(20); });

document.querySelector('#brushSize3').addEventListener('click', function () { changeBrushSize(30); });

document.querySelector('#brushSize4').addEventListener('click', function () { changeBrushSize(100); });
